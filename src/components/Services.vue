      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div
            ...
            thought out design specs. After all, that's where the majority of amazing user experiences
            start.</p>
          </div>
        </div>
        <div class="col-md-4 mb-4">
        ...
        <div
          ...
          <div class="expertise-block">
            ...
            <p class="summary">I design in the browser with HTML, CSS and a touch of JavaScript. I love
            coding things from scratch, but I can work with front-end frameworks like Bootstrap too.</p>
          </div>
        </div>
      </div>
    </div>
